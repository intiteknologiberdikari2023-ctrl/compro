export default function Footer() {
  return (
    <>
      {/* <section className="flex flex-col -bg-gradient justify-end">
        <div className="w-full">
          <div className="container mx-auto flex flex-col">
            <div className="my-8 flex w-full flex-col items-center">
              <div className="mb-5 shrink-0">
                <img className="h-12" src="images/inteblogo.png" />
              </div>
              ...
              <div className="flex items-center">
                <p className="text-center text-sm font-medium leading-7 text-primary">
                  ©
                  2025
                  Inofix Studio. All rights reserved.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="-bg-gradient">
        <div className="w-full py-10 px-4 sm:px-6 text-gray-800 sm:flex justify-between mx-auto">
          <div className="p-5 sm:w-7/12">
            <img className="h-12 mb-4" src="images/inteb.png" />
            <p className="text-lg text-primary mb-3">
            Hubungi kami dan temukan solusi inovatif yang mampu mendorong pertumbuhan bisnis Anda. Tidak hanya mendapatkan layanan digital, tetapi juga kemitraan yang dapat diandalkan dalam perjalanan transformasi bisnis digital yang nyata.
            </p>
            <small>powered by</small>
            <div className="flex mt-3 ">
              <img width="30" height="20" src="images/inteb.png"></img>
          ...
          <div className="p-5 sm:w-3/12">
            ...
            <ul>
              ...
              <li className="my-2">
                <a className="hover:text-primary" href="#">
                 intiteknologiberdikari@gmail.com
                </a>
              </li>
            </ul>
          </div>
        </div>
        <div className="flex pb-5 pt-0 m-auto text-gray-800 text-sm flex-col items-center  max-w-screen-xl">
          <div className="mb-5 flex flex-col items-center gap-6">
            <div className="flex items-center gap-8">
              <a href="#">
                <svg
