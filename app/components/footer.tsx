...
export default function Footer() {
  ...
  <Image
    src="/images/inteb.png"
    alt="Logo Inti Teknologi Berdikari"
    width={50}
    height={100}
    className="h-12 mb-4"
  />
  ...
  <p className="text-lg text-primary mb-3">
    Hubungi kami dan temukan solusi inovatif yang mampu mendorong pertumbuhan bisnis Anda. 
    Tidak hanya mendapatkan layanan digital, tetapi juga kemitraan yang dapat diandalkan 
    dalam perjalanan transformasi bisnis digital yang nyata.
  </p>
